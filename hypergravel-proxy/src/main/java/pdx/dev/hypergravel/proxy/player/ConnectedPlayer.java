package pdx.dev.hypergravel.proxy.player;
...
public final class ConnectedPlayer implements Player {
    ...
    public CompletableFuture<ConnectionResult> connect(RegisteredServer server) {
        ...
        return proxy.connector().connect(this, target,
                pdx.dev.hypergravel.api.event.PreServerConnectEvent.Reason.COMMAND);
    }
    ...
    public void disconnect(Component reason) {
        ...
        boolean nbt = connection.state() != pdx.dev.hypergravel.proxy.protocol.ProtocolState.LOGIN;
