...
import media.gitm.hypergravel.api.event.DisconnectEvent;
import media.gitm.hypergravel.api.event.EventManager;
import media.gitm.hypergravel.api.event.ServerHealthChangeEvent;
...
import media.gitm.hypergravel.proxy.auth.EncryptionManager;
import media.gitm.hypergravel.proxy.auth.MojangAuthenticator;
import media.gitm.hypergravel.proxy.backend.BackendConnector;
import media.gitm.hypergravel.proxy.backend.HyperGravelServer;
import media.gitm.hypergravel.proxy.backend.ServerRegistry;
import media.gitm.hypergravel.proxy.command.HyperGravelCommandManager;
import media.gitm.hypergravel.proxy.command.ServerCommand;
import media.gitm.hypergravel.proxy.config.HyperGravelConfig;
import media.gitm.hypergravel.proxy.event.HyperGravelEventManager;
import media.gitm.hypergravel.proxy.network.Transport;
import media.gitm.hypergravel.proxy.player.ConnectedPlayer;
import media.gitm.hypergravel.proxy.player.PlayerRegistry;
import media.gitm.hypergravel.proxy.queue.QueueService;
import media.gitm.hypergravel.proxy.scheduler.HyperGravelScheduler;
import media.gitm.hypergravel.proxy.security.ConnectionThrottle;
...
public final class HyperGravelProxy implements ProxyServer {
    ...
    private final media.gitm.hypergravel.proxy.ban.ProxyBans proxyBans;
    private final media.gitm.hypergravel.proxy.ban.ProxyMutes proxyMutes;
    ...
    public HyperGravelProxy(HyperGravelConfig initialConfig, Path configDirectory) {
        ...
        this.proxyBans = new media.gitm.hypergravel.proxy.ban.ProxyBans(configDirectory);
        this.proxyMutes = new media.gitm.hypergravel.proxy.ban.ProxyMutes(configDirectory);
    ...
    public media.gitm.hypergravel.proxy.ban.ProxyBans proxyBans() {
        return proxyBans;
    }
    ...
    public media.gitm.hypergravel.proxy.ban.ProxyMutes proxyMutes() {
        return proxyMutes;
    }
    ...
    public static final class Messenger {
        ...
        public void sendActionBar(ConnectedPlayer player, Component message) {
            ...
            if (connection.active()
                ...
                connection.writeAndFlush(
                        new media.gitm.hypergravel.proxy.protocol.packet.PlayPackets.SystemChat(
                                message, true));
            }
        }
        ...
        public void sendSystemMessage(ConnectedPlayer player, Component message) {
            ...
            if (connection.active()
                    && connection.state() == media.gitm.hypergravel.proxy.protocol.ProtocolState.PLAY) {
                connection.writeAndFlush(
                        new media.gitm.hypergravel.proxy.protocol.packet.PlayPackets.SystemChat(message));
            } else {
