...
import media.gitm.hypergravel.proxy.network.codec.CipherCodec;
import media.gitm.hypergravel.proxy.network.codec.CompressionCodec;
...
public final class MinecraftConnection extends ChannelInboundHandlerAdapter {
    ...
    public boolean supports(media.gitm.hypergravel.proxy.protocol.PacketType type) {
        MinecraftEncoder encoder = encoder();
