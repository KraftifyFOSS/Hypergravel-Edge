...
import media.gitm.hypergravel.api.event.ServerConnectedEvent;
import media.gitm.hypergravel.api.player.Player;
import media.gitm.hypergravel.api.server.ForwardingMode;
import media.gitm.hypergravel.proxy.HyperGravelProxy;
import media.gitm.hypergravel.proxy.forwarding.LegacyForwarding;
...
import media.gitm.hypergravel.proxy.network.handler.BackendLoginHandler;
import media.gitm.hypergravel.proxy.network.handler.BackendPlaySessionHandler;
import media.gitm.hypergravel.proxy.network.handler.ClientPlaySessionHandler;
...
private void announceChannels(BackendConnection backend) {
        String channels = String.join("",
                "bungeecord:main\u0000" + media.gitm.hypergravel.proxy.queue.QueueService.CHANNEL);
