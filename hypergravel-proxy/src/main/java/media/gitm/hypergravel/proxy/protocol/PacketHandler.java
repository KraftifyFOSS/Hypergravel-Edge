...
public interface PacketHandler {
    ...
    default boolean handle(media.gitm.hypergravel.proxy.protocol.packet.CommandPackets.Commands packet) {
        return false;
    }

    default boolean handle(
            media.gitm.hypergravel.proxy.protocol.packet.CommandPackets.SuggestionRequest packet) {
        return false;
    }
